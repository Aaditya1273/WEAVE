...
// WEAVE addition: `VITE_PREVIEW_URL` lets a single-origin deploy serve the
// preview bundle from a path (e.g. `/preview-sandbox`) instead of port 5175.
const PREVIEW_ORIGIN =
  (import.meta.env.VITE_PREVIEW_URL as string | undefined)?.replace(/\/$/, '') ||
