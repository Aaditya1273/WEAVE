...
export const heroEditorial: SectionBlueprint = {
  ...
  <div data-id="hfr-backdrop" data-name="Backdrop" data-pinned="true" aria-hidden="true" style={{
  ...
  <div data-id="hfr-scrim" data-name="Scrim" data-pinned="true" aria-hidden="true" style={{
    position: 'absolute', left: '0px', top: '0px', width: '100%', height: '100%',
