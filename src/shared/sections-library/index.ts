...
// WEAVE additions — the section vocabulary weave_add_section exposes to agents.
import { featuresGrid } from './blueprints/features-grid';
import { productGrid } from './blueprints/product-grid';
import { testimonialsCards } from './blueprints/testimonials-cards';
import { pricingTiers } from './blueprints/pricing-tiers';
import { faqList } from './blueprints/faq-list';
import { ctaBanner } from './blueprints/cta-banner';
import { contactPanel } from './blueprints/contact-panel';
import { footerColumns } from './blueprints/footer-columns';
