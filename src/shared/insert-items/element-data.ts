...
export const CATEGORIES: InsertCategory[] = [
  ...
  // Re-enabled by WEAVE: the same library weave_add_section exposes to agents,
  // so humans and agents insert from ONE section vocabulary.
  {
    id: 'sections',
    label: 'Sections',
    iconKey: 'sections',
    ...
    sections: [
      ...
      { id: 'features', label: 'Features', items: sectionLibraryItems('features') },
      { id: 'products', label: 'Products', items: sectionLibraryItems('products') },
      { id: 'testimonials', label: 'Testimonials', items: sectionLibraryItems('testimonials') },
      { id: 'pricing', label: 'Pricing', items: sectionLibraryItems('pricing') },
      { id: 'faq', label: 'FAQ', items: sectionLibraryItems('faq') },
      { id: 'cta', label: 'Calls to action', items: sectionLibraryItems('cta') },
      { id: 'contact', label: 'Contact', items: sectionLibraryItems('contact') },
      { id: 'footers', label: 'Footers', items: sectionLibraryItems('footer') },
    ],
  },
