<!-- Upstream README of https://github.com/revyme-web/builder (main), fetched 2026-09-04 and preserved verbatim for attribution. WEAVE's own README is at the repository root. -->
